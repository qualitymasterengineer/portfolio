...
window.TRANSLATIONS = {
  en: {
    ...
    about_us: {
      ...
      about_us_mission_text: 'To deliver high-level quality assurance solutions that enable organizations to deploy software with full confidence, speed and security.',
      about_us_focus_title: 'Our Focus',
      about_us_focus_text: 'We combine a decade of technical experience with leading tools (Playwright, Cypress, JMeter) to build automated, resilient testing ecosystems and deliver results: fewer production bugs, faster time-to-market and lower costs through automation.',
      ...
      about_us_svc1_desc: 'Development of scripts with Playwright, Selenium and Cypress. Implementation of custom frameworks for E2E coverage and release optimization.',
      about_us_svc2_title: 'Performance & Scalability',
      about_us_svc2_desc: 'Load and stress analysis with JMeter and K6. Optimization of stability in critical architectures under high traffic demand.',
      about_us_svc3_title: 'Mobile Testing & QA',
      about_us_svc3_desc: 'Automated and manual testing for iOS and Android with Appium. Validation of UI/UX and performance across diverse mobile ecosystems.',
      about_us_svc4_title: 'Manual QA Control',
      about_us_svc4_desc: 'Critical scenario detection through human-in-the-loop. Defect management with Jira, Azure DevOps and ClickUp.',
      about_us_svc5_title: 'Infrastructure & CI/CD',
      about_us_svc5_desc: 'Design of Build and Release pipelines. Environment management with Docker, Kubernetes and GitHub Actions for efficient deployments.',
      about_us_svc6_title: 'Data & API Validation',
      about_us_svc6_desc: 'Advanced validation with Postman and integration with SQL and NoSQL databases for end-to-end data integrity.',
      about_us_svc7_title: 'Technical Leadership',
      about_us_svc7_desc: 'Definition of global strategies and standards under agile methodologies. Mentoring and operational excellence in every development cycle.',
      about_us_svc8_title: 'Observability & QE',
      about_us_svc8_desc: 'Proactive monitoring in production environments and log interpretation for prevention of critical failures and high availability.'
    },
    resume: {
    ...
    expertise: {
      ...
      expertise_trajectory_title: 'Trajectory & Solutions',
  ...
  es: {
    ...
    about_us: {
      ...
      about_us_mission_text: 'Proveer soluciones de aseguramiento de calidad de alto nivel que permitan a las empresas desplegar software con total confianza, velocidad y seguridad.',
      about_us_focus_title: 'Nuestro enfoque',
      about_us_focus_text: 'Combinamos una década de experiencia técnica con herramientas líderes (Playwright, Cypress, JMeter) para crear ecosistemas de prueba automatizados y resilientes, y entregar resultados: menos bugs en producción, menor time-to-market y optimización de costos mediante automatización.',
      about_us_stat1_number: '+10',
      ...
      about_us_svc1_title: 'Automation Frameworks',
      about_us_svc1_desc: 'Desarrollo de scripts con Playwright, Selenium y Cypress. Implementación de frameworks custom para cobertura E2E y optimización de release.',
      about_us_svc2_title: 'Performance & Scalability',
      about_us_svc2_desc: 'Análisis de carga y estrés con JMeter y K6. Optimización de estabilidad en arquitecturas críticas bajo alta demanda de tráfico.',
      about_us_svc3_title: 'Mobile Testing & QA',
      about_us_svc3_desc: 'Pruebas automatizadas y manuales para iOS y Android con Appium. Validación de UI/UX y rendimiento en diversos ecosistemas móviles.',
      about_us_svc4_title: 'Manual QA Control',
      about_us_svc4_desc: 'Detección de escenarios críticos mediante human-in-the-loop. Gestión de defectos en Jira, Azure DevOps y ClickUp.',
      about_us_svc5_title: 'Infrastructure & CI/CD',
      about_us_svc5_desc: 'Diseño de pipelines de Build y Release. Gestión de entornos con Docker, Kubernetes y GitHub Actions para despliegues eficientes.',
      about_us_svc6_title: 'Data & API Validation',
      about_us_svc6_desc: 'Validación avanzada con Postman e integración con bases de datos SQL y NoSQL para integridad de data end-to-end.',
      about_us_svc7_title: 'Technical Leadership',
      about_us_svc7_desc: 'Definición de estrategias globales y estándares bajo metodologías ágiles. Mentoría y excelencia operativa en cada ciclo de desarrollo.',
      about_us_svc8_title: 'Observability & QE',
      about_us_svc8_desc: 'Monitoreo proactivo en entornos productivos e interpretación de logs para prevención de fallos críticos y alta disponibilidad.'
    },
    resume: {
    ...
    expertise: {
      ...
      expertise_trajectory_title: 'Trayectoria y Soluciones',
